...
/*Route::get('/', function () {
    Storage::disk("google")->put("test.txt", "Hola prueba 1");
    return 'Prueba';
});*/
/*
Route::get('/', function () {
...
Route::get('/google-drive/download/{filename}', [GoogleDriveController::class, 'download'])->name('google-drive.download');
Route::post('/google-drive/change-visibility/{filename}', [GoogleDriveController::class, 'changeVisibility'])->name('google-drive.changeVisibility');
Route::get('/google-drive/delete-file/{filename}', [GoogleDriveController::class, 'deleteFile'])->name('google-drive.delete-file');
Route::post('/google-drive/rename-file/{filename}', [GoogleDriveController::class, 'renameFile'])->name('google-drive.rename-file');
Route::post('/google-drive/makedirectory', [GoogleDriveController::class, 'makedirectory'])->name('google-drive.makedirectory');
Route::get('/google-drive/delete-directory/{directory}', [GoogleDriveController::class, 'deleteDirectory'])->name('google-drive.delete-directory');
Route::get('/google-drive/view-file/{filename}', [GoogleDriveController::class, 'viewFile'])->name('google-drive.view-file');



Route::get('put', function() {
    Storage::disk()->put('test.txt', 'Hello World');
